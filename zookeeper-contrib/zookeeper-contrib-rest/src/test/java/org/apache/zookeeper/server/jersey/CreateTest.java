...
public class CreateTest extends Base {
    ...
    @ParameterizedTest
    @MethodSource("data")
    public void testCreate(String accept, String path, String name,
            String encoding, ClientResponse.Status expectedStatus,
            ZPath expectedPath, byte[] data, boolean sequence) throws Exception {
