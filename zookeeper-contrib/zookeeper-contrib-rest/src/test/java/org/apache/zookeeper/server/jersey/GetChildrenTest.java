...
public class GetChildrenTest extends Base {
    ...
    @ParameterizedTest
    @MethodSource("data")
    public void testGetChildren(String accept, String path,
            ClientResponse.Status expectedStatus, String expectedPath,
            List<String> expectedChildren) throws Exception {
